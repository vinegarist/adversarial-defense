...
print(f'攻击类型: {results["attack_type"]}')
print('=' * 80)

# 保存结果
os.makedirs('./results_figures', exist_ok=True)
csv_path = './results_figures/transfer_attack_mixedat.csv'
df_result.to_csv(csv_path, index=False)
print(f'\n[SAVED] 结果已保存: {csv_path}')
